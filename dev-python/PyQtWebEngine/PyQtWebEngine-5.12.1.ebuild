...
DESCRIPTION="Python bindings for QtWebEngine under the PyQt framework"
...
RDEPEND="
	...
	!widgets? ( >=dev-python/PyQt5-5.12_pre:=[network,${PYTHON_USEDEP}] )
	widgets? ( >=dev-python/PyQt5-5.12_pre:=[network,widgets,printsupport,webchannel,${PYTHON_USEDEP}] )
"
